...
public class blackmould extends AppCompatActivity {

    ImageView back;
    TextView detailtext,soilinfo,fertidetail;
    LinearLayout layout,soil,fertilizer;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_blackmould);
        ...
        back.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent back=new Intent(blackmould.this,cropcare.class);
                startActivity(back);
            }
        });
    }
